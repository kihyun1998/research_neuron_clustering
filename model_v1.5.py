...
# with open("rec1.csv", "w") as f:
#     csv.writer(f).writerows(zip(t, rec1))
# with open("rec2.csv", "w") as f:
#     csv.writer(f).writerows(zip(t, rec2))
# with open("rec3.csv", "w") as f:
#     csv.writer(f).writerows(zip(t, rec3))
