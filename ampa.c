...
#define Tspike _p[3]
#define Tspike_columnindex 3
#define Nspike _p[4]
#define Nspike_columnindex 4
#define iampa _p[5]
#define iampa_columnindex 5
#define local_v _p[6]
#define local_v_columnindex 6
#define gampa _p[7]
#define gampa_columnindex 7
#define Dgampa _p[8]
#define Dgampa_columnindex 8
#define _g _p[9]
...
static void _initlists() {
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = gampa_columnindex;  _dlist1[0] = Dgampa_columnindex;
_first = 0;
}
